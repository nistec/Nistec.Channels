    ...
    public abstract class AnonymousPipeClient : IDisposable
    {
        ...
        public void Execute(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Client ReadRequest Command:{0}, Key:{1}, Size:{1}", request.Command, request.Key, request.Size);
                ...
                else
                {
                    ...
                    Console.WriteLine("Client Response :Command:{0}, Key:{1}, Size:{1}", response.Command, response.Key, response.Size);
