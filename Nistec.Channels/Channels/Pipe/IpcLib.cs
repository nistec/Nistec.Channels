...
namespace Nistec.Channels.Pipe
{
    ...
    public class IpcServer
    {
        ...
        private ConcurrentDictionary<PipeStream, IpcPipeData> m_pipes = new ConcurrentDictionary<PipeStream, IpcPipeData>();
        ...
        private void BeginRead(IpcPipeData pd)
        {
            ...
            if (!isConnected)
            {
                ...
                //{
                    IpcPipeData val;
                    bool removed = m_pipes.TryRemove(pd.pipe, out val);
